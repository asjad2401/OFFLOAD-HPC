 ...
 *
 * IMPORTANT: This interface MUST use the same fully-qualified class name
 * (com.offloadhpc.contract.WorkerService) in both Broker and Worker projects
 * for Java RMI to work correctly.
 */
